...
<div id="layout_north_pfMenu" style="width: 120px; display: none;">
	...
	<div onclick="changeThemeFun('gray');" title="gray">灰色</div>
	<div onclick="changeThemeFun('bootstrap');" title="bootstrap">bootstrap</div>
	<div onclick="changeThemeFun('black');" title="black">黑色-浅</div>
	<div class="menu-sep"></div>
	<div onclick="changeThemeFun('cupertino');" title="cupertino">玻璃绿</div>
	<div onclick="changeThemeFun('dark-hive');" title="dark-hive">黑色-深</div>
	<div onclick="changeThemeFun('pepper-grinder');" title="pepper-grinder">纸色</div>
	<div onclick="changeThemeFun('sunny');" title="sunny">暖色</div>
	<div class="menu-sep"></div>
	<div onclick="changeThemeFun('metro');" title="metro">WIN8-白</div>
	<div onclick="changeThemeFun('metro-blue');" title="metro-blue">WIN8-蓝</div>
	<div onclick="changeThemeFun('metro-gray');" title="metro-gray">WIN8-灰</div>
	<div onclick="changeThemeFun('metro-green');" title="metro-green">WIN8-绿</div>
	<div onclick="changeThemeFun('metro-orange');" title="metro-orange">WIN8-黄</div>
	<div onclick="changeThemeFun('metro-red');" title="metro-red">WIN8-红</div>
</div>
